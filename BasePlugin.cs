...
#pragma warning restore IDE0051 // Remover membros privados não utilizados
		{
			...
			LoadingEvents.RegisterOnAssetsLoaded(Info, () =>
			{
				...
				roomChaosScene.levelObject.minSize = new(5, 5);
				roomChaosScene.levelObject.maxSize = new(10, 10);
				roomChaosScene.levelObject.minPlots = 1;
				roomChaosScene.levelObject.maxPlots = 1;
				roomChaosScene.levelObject.minPlotSize = 0;
